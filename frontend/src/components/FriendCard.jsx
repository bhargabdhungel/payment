...
import { currentFriendAtom } from "../store/user";

export default function FriendCard() {
  const friend = useRecoilValue(currentFriendAtom);
  ...
  return (
    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="flex flex-col items-center pb-10">
        <div className="relative cursor-pointer inline-flex items-center justify-center w-16 h-16 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
